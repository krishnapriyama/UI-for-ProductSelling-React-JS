  ...
  return (
    <>
      <div className="flex flex-col h-full mt-20 lg:flex-row m-5 p-6">
                ...
                <div className="ml-5">
                  ...
                  <div className="bg-transparent w-1/2 md:w-auto h-full absolute left-0 md:left-80 top-20 md:top-32 lg:left-[22rem]">
                    <div className="h-auto flex-row items-center">
                      <h1 className="w-6 h-5 font-bold text-[1.5rem] leading-5 text-[#677DA8] inline-block">
                        4.3
                      </h1>
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2 sm:mt-44 lg:mt-0 ">
          <div className="relative w-[40rem]">
            <div className="z-auto mb-16">
              <img
                src={Shoe}
            ...
            <img
              ...
              loading="lazy"
            />
           <div className='border-gradient w-80 h-28 absolute bottom-0 right-0 rounded-xl'>
           <div className="w-[19.5rem] h-[6.5rem] bg-[#fff] absolute bottom-0 right-0 rounded-xl m-1 ">
              <div className="m-5 text-[#677DA8] ">
                <h2 className="uppercase font-extrabold ">
                  Get Up to 30% Off
                </h2>
                <p className='font-'>You can get 30% off this product if you are buying now</p>
              </div>
            </div>
           </div>
          </div>
